...
/* eslint-disable -- ported imperative three.js/WebGL orb (mutates uniforms in
   useFrame, ref access in render); React Compiler / lint rules don't model r3f. */
...
/** 3D shader orb — the persona's living avatar. `colors` drives the gradient,
 *  `agentState` animates it (idle / listening / talking). Ported from the
 *  ElevenLabs orb, trimmed to the props this app needs. */
export function Orb({

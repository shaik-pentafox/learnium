...
/** ALFA Learnium brand mark. Two interlocking speech-bubble forms in the
 *  indigo brand palette. Size via `className` (e.g. `size-8`). */
export function Logo({ className }: LogoProps) {
  return (
    <svg viewBox="8.75 22.5 81.5 81.5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="ALFA Learnium Logo" transform="matrix(-1,0,0,1,0,0)" className={className}>
